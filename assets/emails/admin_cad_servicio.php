...
$stmt = mysqli_prepare( $conexion, "
	...
	WHERE
		 s.nueva_fecha_servicio < CURDATE()
		AND a.activo = 1
		AND a.estatus = 1 ;" );
$stmt->execute();
...
<body>
  ...
  <p>El motivo de mi correo es para informarle que de acuerdo con nuestros registros hemos identificado algunos vehículos que, hasta el momento, no han realizado su servicio de mantenimiento correspondiente.</p>

<p>A continuación, le proporciono la lista de los vehículos antes mencionados y que requieren atención inmediata:</p>
