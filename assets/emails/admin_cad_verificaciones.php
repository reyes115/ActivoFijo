...
$stmt = mysqli_prepare( $conexion, "
	...
	WHERE 
		DATEDIFF(CURDATE(), `VencVerificacion`) > 0 AND DATEDIFF(CURDATE(), `VencVerificacion`) <= 30
  and activo=1 and estatus=1 ;" );
$stmt->execute();
...
$to = $email;
$subject = 'Recordatorio de Verificaciones Pendientes del Mes Pasado';
$message = '
	<html>
<head>
</head>
<body>
  ...
  <p>El propósito de mi correo es recordarte sobre las verificaciones programadas para los vehículos que no fueron atendidas el mes pasado. La siguiente lista detalla los vehículos que deberán someterse a verificación:</p>
