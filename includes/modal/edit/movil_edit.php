       <!-- Modal Delete-->
        <div class="modal fade" id="delete<?php echo $row['id_compu'];?>" tabindex="-1" role="dialog" aria-labelledby="bloquearLabel" aria-hidden="true">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="post" enctype="multipart/form-data">
                  <input type="hidden" name="id" id="id" value="<?php echo $row['id_compu'];?>">
