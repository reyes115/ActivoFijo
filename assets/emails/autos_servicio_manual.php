...
if ($row) {
    ...
    $mes_num = date('m', strtotime($row['ultimo_servicio']));
    $mes = '';
    switch ($mes_num) {
    ...
    <body>
      ...
      <p>El motivo de mi correo es informarle que el último servicio de mantenimiento del vehículo <b> ' . $row['marca'] . ' ' . $row['tipo'] . ' ' . $row['modelo'] . ' ' . $row['vin'] . ' </b>fue realizado el <b>' . date('d', strtotime($row['ultimo_servicio'])) . ' de ' . $mes . ' del ' . date('Y', strtotime($row['ultimo_servicio'])) . '</b> por lo que es necesario realizar nuevamente el servicio de mantenimiento.</p>
