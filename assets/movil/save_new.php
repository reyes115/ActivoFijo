...
$stmt = $conexion->prepare( "SELECT MAX(cons) as cons FROM celular LIMIT 1" );
$stmt->execute();
...
// guardar archivos
$directorio = $_SERVER[ 'DOCUMENT_ROOT' ] . "/uploads/moviles/$codigo"; //Declaramos un  variable con la ruta donde guardaremos los archivos
...
$t_qr = "moviles";
$urlQr="https://ceers.innovet.com.mx/ver_movil".$QRKey;
...
// Vincular parámetros
$stmt->bind_param("ssssssssssssssi", $codigo, $propietario, $no_telefono, $region, $marca, $modelo, $imei, $no_serie, $color, $no_cargador, $disponible, $obs, $usuarioAsignado, $QRKey, $cons);

//variables para guardar historial
$usu_usuario = $_SESSION[ 'user_name' ];
$accion = "Registro nuevo equipo de movil: " . $codigo;
